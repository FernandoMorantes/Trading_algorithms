...
def make_pipeline():
    ...
    revenue = Fundamentals.gross_profit.latest
    
    netincomeopsgrowth = Fundamentals.net_income_cont_ops_growth.latest
    
    netincomegrowth = Fundamentals.net_income_growth.latest
    
    entvalue = Fundamentals.enterprise_value.latest
    
    marketcap = Fundamentals.market_cap.latest
    
    salespershare = Fundamentals.sales_per_share.latest
    
    salesyield =  Fundamentals.sales_yield.latest
    ...
    accounts_receivable_winsorized = accountsreceivable.winsorize(min_percentile=0.05, max_percentile=0.95)  
    additional_capital_winsorized = additionalcapital.winsorize(min_percentile=0.05, max_percentile=0.95)
    
    capital_stock_winsorized = capitalstock.winsorize(min_percentile=0.05, max_percentile=0.95)
    
    current_assets_winsorized = currentassets.winsorize(min_percentile=0.05, max_percentile=0.95)
    
    current_debt_winsorized = currentdebt.winsorize(min_percentile=0.05, max_percentile=0.95)
    
    diluted_growth_winsorized = dilutedgrowth.winsorize(min_percentile=0.05, max_percentile=0.95)
    
    diluted_eps_growth_winsorized = dilutedepsgrowth.winsorize(min_percentile=0.05, max_percentile=0.95)
    
    diluted_cont_eps_growth_winsorized = dilutedcontepsgrowth.winsorize(min_percentile=0.05, max_percentile=0.95)
    
    cash_financing_activities_winsorized = cashfinancingactivities.winsorize(min_percentile=0.05, max_percentile=0.95)
    
    cash_investing_activities_winsorized = cashinvestingactivities.winsorize(min_percentile=0.05, max_percentile=0.95)
    
    cash_operating_activities_winsorized = cashoperatingactivities.winsorize(min_percentile=0.05, max_percentile=0.95)
    
    change_in_inventory_winsorized = changeinventory.winsorize(min_percentile=0.05, max_percentile=0.95)
    
    revenue_winsorized = revenue.winsorize(min_percentile=0.05, max_percentile=0.95)
    
    netincomeopsgrowth_winsorized = netincomeopsgrowth.winsorize(min_percentile=0.05, max_percentile=0.95)
    
    netincomegrowth_winsorized = netincomegrowth.winsorize(min_percentile=0.05, max_percentile=0.95)
    
    entvalue_winsorized = entvalue.winsorize(min_percentile=0.05, max_percentile=0.95)
    
    marketcap_winsorized = marketcap.winsorize(min_percentile=0.05, max_percentile=0.95)
    
    salespershare_winsorized = salespershare.winsorize(min_percentile=0.05, max_percentile=0.95)
    
    salesyield_winsorized = salesyield.winsorize(min_percentile=0.05, max_percentile=0.95)
    ...
    combined_factor = (
        ...
        current_assets_winsorized.zscore() -     
        current_debt_winsorized.zscore() +
        ...
        netincomeopsgrowth_winsorized.zscore() -
        netincomegrowth_winsorized.zscore() -
        entvalue_winsorized.zscore() -
        marketcap_winsorized.zscore() -
        salespershare_winsorized.zscore() -
        salesyield_winsorized.zscore() 
     )
